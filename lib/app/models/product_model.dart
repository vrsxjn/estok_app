import 'dart:io';
import 'dart:async';
import 'package:app_flutter/app/repository/api/product_api.dart';
...
import 'package:app_flutter/app/repository/api/uploadApi.dart';
...
class ProductModel extends Model {
  ...
  void deletarProduto(int id, int produto,
    ...
    if (messageData != null) {
      ...
      onFail('Erro ao deletar o carro');
    }
    setState();
  }
